...
The primary task entry has Reading, Writing and Abstract input, with original requirements. Abstract input reveals Tap/Drag/Vertical scroll/Horizontal scroll. Retain all six underlying operation labels/data and reading-scroll context. Do not imply six independent original experiments.
