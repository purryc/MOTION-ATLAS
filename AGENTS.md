...
Use maximal continuous qualifying episodes at fixed speed <20mm/s and >300ms touch exclusion, then filter minimum duration at 100/200/300/400/500/600/700/800/900/1000ms. Do not truncate longer episodes to the threshold. Apply the same threshold choices to report, replay, exports and source-derived summaries. Display task-wide totals and distinguish current clip/current episode. Timelines support pointer dragging and original-frame seeking. Volumetric heat maps use actual valid samples in documented voxel bins with count conservation; absence of stable samples never becomes inferred dwell. Report height switches affect absolute thumb height tables/charts and preserve original findings/relative-event metrics.
