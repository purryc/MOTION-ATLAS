...
def main():
 ...
 files=[('src/viewer/index.html','index.html'),('outputs/report.html','outputs/report.html'),('outputs/ui-position-calibration.json','outputs/ui-position-calibration.json'),('outputs/participants.json','outputs/participants.json')]
